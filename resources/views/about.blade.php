...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><a href="{{route('about')}}" title="Reload">About</a></li>
        </ol>
    </nav>
    <!-- //breadcrumbs -->
   <!--services-->
                    ...
                    {{--<div id="owl-demo" class="owl-carousel text-center">--}}
                                ...
                                {{--<div class="men-thumb-item">--}}
                                    ...
                                    {{--<div class="men-cart-pro">--}}
                                        {{--<div class="inner-men-cart-pro">--}}
                                            {{--<a href="womens.blade.php" class="link-product-add-cart">Quick View</a>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                {{--<!-- card body -->--}}
                        ...
                        {{--<div class="item">--}}
                            {{--<div class="product-men p-3 text-center">--}}
                                ...
                                {{--<a href="women.blade.php" class="btn btn-lg bg-info text-white">view more</a>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">--}}
                    {{--<div id="owl-demo1" class="owl-carousel text-center">--}}
                        {{--<div class="item">--}}
                            ...
                            {{--<div class="card product-men p-3">--}}
                                {{--<div class="men-thumb-item">--}}
                                    ...
                                    {{--<div class="men-cart-pro">--}}
                                        {{--<div class="inner-men-cart-pro">--}}
                                            {{--<a href="mens.blade.php" class="link-product-add-cart">Quick View</a>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                {{--<!-- card body -->--}}
                        ...
                        {{--<div class="item">--}}
                            ...
                            {{--<div class="product-men p-3 text-center">--}}
                                {{--<img src="images/p2.png" class="img-responsive" alt="">--}}
                                {{--<a href="men.blade.php" class="btn btn-lg bg-info text-white">view more</a>--}}
                            {{--</div>--}}
                            {{--<!-- //card -->--}}
                        {{--</div>--}}
                    {{--</div>--}}
                ...
                {{--<div role="tabpanel" class="tab-pane fade" id="girl" aria-labelledby="girl-tab">--}}
                    {{--<div id="owl-demo2" class="owl-carousel text-center">--}}
                        {{--<div class="item">--}}
                            ...
                            {{--<div class="card product-men p-3">--}}
                                {{--<div class="men-thumb-item">--}}
                                    ...
                                    {{--<div class="men-cart-pro">--}}
                                        {{--<div class="inner-men-cart-pro">--}}
                                            {{--<a href="girl.blade.php" class="link-product-add-cart">Quick View</a>--}}
                                        {{--</div>--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                {{--<!-- card body -->--}}
                        ...
                        {{--<div class="item">--}}
                            {{--<div class="product-men p-3 text-center">--}}
                                {{--<img src="images/p2.png" class="img-responsive" alt="" />--}}
                                {{--<a href="girls.blade.php" class="btn btn-lg bg-info text-white">view more</a>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
                ...
                {{--<div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">--}}
                    {{--<div id="owl-demo3" class="owl-carousel text-center">--}}
                        ...
                        {{--<div class="item">--}}
                            {{--<div class="product-men p-3 text-center">--}}
                                {{--<img src="images/p2.png" class="img-responsive" alt="" />--}}
                                {{--<a href="boys.blade.php" class="btn btn-lg bg-info text-white">view more</a>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
