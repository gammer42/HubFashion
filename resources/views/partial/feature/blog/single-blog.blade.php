            ...
            <div class="row show-top-grids">
                <div class="col-md-7 single-left">
                    <div class="card">
                        ...
                        <img class="card-img-bottom" src="{{asset('frontend/images/blg1.jpg')}}" alt="Card image cap">
                    </div>
                    ...
                    <div class="all-comments p-sm-5 p-3 mt-5">
                        ...
                        <div class="media py-5">
                            <img class="mr-3" src="{{asset('frontend/images/m.png')}}" alt="Generic placeholder image">
                            <div class="media-body">
                                ...
                                <div class="media mt-5">
                                    <a class="pr-3" href="#">
                                        <img src="{{asset('frontend/images/f.png')}}" alt="Generic placeholder image">
                                    </a>
                                    <div class="media-body">
                    ...
                    <div class="card my-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <ul class="w3-tag2">
                                    <li>
                                        <a href="shop.blade.php">amet</a>
                                    </li>
                                    <li>
                                        <a href="#">placerat</a>
                                    </li>
                                    <li>
                                        <a href="shop.blade.php">Proin </a>
                                    </li>
                                    <li>
                                        <a href="#">vehicula</a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="shop.blade.php">velit</a>
                                    </li>
                                    <li>
                                        <a href="shop.blade.php">felis</a>
                                    </li>
                                    <li>
