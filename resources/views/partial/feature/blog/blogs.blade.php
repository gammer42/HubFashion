    ...
    <div class="container">
        ...
        <div class="row card-columns py-lg-5">
            <div class="col-md-4 p-0">
                <div class="card">
                    <a href="{{route('blogs.single')}}">
                        <img class="card-img-top" src="{{asset('frontend/images/blg1.jpg')}}" alt="Card image cap">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title blg_w3ls">
                            <a href="{{route('blogs.single')}}">Blog Title</a>
                        </h5>
                ...
                <div class="card">
                    <a href="{{route('blogs.single')}}">
                        <img class="card-img-top" src="{{asset('frontend/images/a2.jpg')}}" alt="Card image cap">
                    </a>
                    <div class="card-body">
                        <h5 class="card-title blg_w3ls">
                            <a href="{{route('blogs.single')}}">Blog Title</a>
            ...
            <div class="col-md-4 0">
                ...
                <div class="card text-white text-center">
                    <a href="{{route('blogs.single')}}">
                        <img class="card-img" src="{{asset('frontend/images/a3.jpg')}}" alt="Card image">
                    </a>
            ...
            <div class="col-md-4 p-0">
                <div class="card">
                    <a href="{{route('blogs.single')}}">
                        <img class="card-img" src="{{asset('frontend/images/blg2.jpg')}}" alt="Card image">
                    </a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="{{route('blogs.single')}}">
                        <img class="card-img-top" src="{{asset('frontend/images/i10.jpg')}}" alt="Card image cap">
                    </a>
                </div>
            </div>
        </div>
