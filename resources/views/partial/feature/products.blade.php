            ...
            <div role="tabpanel" class="tab-pane fade show active" id="women" aria-labelledby="women-tab">
                <div id="owl-demo" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pf1.jpg')}}" alt="img" class="card-img-top">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pf2.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pf3.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pf9.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pf11.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="womens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="men" aria-labelledby="men-tab">
                <div id="owl-demo1" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pm1.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pm2.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pm11.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pt1.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pt2.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="mens.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class=" card product-men p-3 ">
                            <div class="men-thumb-item ">
                                <img src="{{asset('frontend/images/pt3.jpg')}}" alt="img " class="card-img-top ">
                                <div class="men-cart-pro ">
                                    <div class="inner-men-cart-pro ">
                                        <a href="mens.html " class="link-product-add-cart ">Quick View</a>
                                    </div>
            ...
            <div role="tabpanel" class="tab-pane fade" id="girl" aria-labelledby="girl-tab">
                <div id="owl-demo2" class="owl-carousel text-center">
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pg1.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pg2.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="girl.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pg3.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="girl.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3 out_w3">
                            <div class="men-thumb-item position-relative">
                                <img src="{{asset('frontend/images/pg7.jpg')}}" alt="img" class="card-img-top">
            ...
            <div role="tabpanel" class="tab-pane fade" id="boy" aria-labelledby="boy-tab">
                <div id="owl-demo3" class="owl-carousel text-center">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pb2.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pb3.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3 out_w3">
                            <div class="men-thumb-item position-relative">
                                <img src="{{asset('frontend/images/pb7.jpg')}}" alt="img" class="card-img-top">
                                <span class="px-2 position-absolute">out of stock</span>
                            </div>
                            <!-- card body -->
                            <div class="card-body  py-3 px-2">
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pb5.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="boy.html" class="link-product-add-cart">Quick View</a>
                                    </div>
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pb6.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="boy.blade.php" class="link-product-add-cart">Quick View</a>
                                    </div>
                                </div>
                            </div>
                            <!-- card body -->
                    ...
                    <div class="item">
                        ...
                        <div class="card product-men p-3">
                            <div class="men-thumb-item">
                                <img src="{{asset('frontend/images/pb8.jpg')}}" alt="img" class="card-img-top">
                                <div class="men-cart-pro">
                                    <div class="inner-men-cart-pro">
                                        <a href="boy.blade.php" class="link-product-add-cart">Quick View</a>
                                    </div>
