                ...
                <div class="row  footer-v2grids w3-agileits">
                    ...
                    <div class="col-lg-3 col-sm-6 footer-v2grid mt-sm-0 mt-5">
                        ...
                        <div class="footer-v2grid1 row">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{asset('frontend/images/bl2.jpg')}}" alt=" " class="img-fluid">
                                </a>
                            </div>
                        ...
                        <div class="footer-v2grid1 row my-2">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{asset('frontend/images/bl1.jpg')}}" alt=" " class="img-fluid">
                                </a>
                            </div>
                            <div class="col-8 footer-v2grid1-right p-0">
                        ...
                        <div class="footer-v2grid1 row">
                            <div class="col-4 footer-v2grid1-left">
                                <a href="blog.html">
                                    <img src="{{asset('frontend/images/bl3.jpg')}}" alt=" " class="img-fluid">
                                </a>
                            </div>
                            <div class="col-8 footer-v2grid1-right p-0">
                    ...
                    <div class="col-lg-3 col-sm-6 footer-v2grid my-lg-0 my-sm-5">
                        ...
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{asset('frontend/images/bl4.jpg')}}" alt=" " class="img-fluid">
                            </a>
                        </div>
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                        ...
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{asset('frontend/images/bl6.jpg')}}" alt=" " class="img-fluid">
                            </a>
                        </div>
                        <div class="footer-v2grid-instagram">
                            <a href="#">
                                <img src="{{asset('frontend/images/bl5.jpg')}}" alt=" " class="img-fluid">
                            </a>
                        </div>
