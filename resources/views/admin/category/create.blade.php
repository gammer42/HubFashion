                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="category_name" class="form-control" name="cat_name" value="{{old('cat_name')}}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select style="color:#888D9B;" class="form-control" name="parent" id="parent" data-placeholder="Parent Category">
                                                        ...
                                                        @foreach($categories as $parent)
                                                            <option class="bold" style="background-color:#0e0e40;" value="{{ $parent->id }}">{{ $parent->cat_name }}</option>
                                            ...
                                            <div class="col-md-7">
                                                <div>
                                                    <input type="radio" id="active"
                                                           name="cat_status" value="1" checked/>
                                                    <label for="active">{{ __('Active') }}</label>
                                                </div>
                                                <div>
                                                    <input type="radio" id="inactive"
                                                           name="cat_status" value="0"/>
