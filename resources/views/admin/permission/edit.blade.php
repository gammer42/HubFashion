...
@section('navbar')
    <a class="navbar-brand" href="#">Permission Updated by Authority</a>
@endsection
@section('content')
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    ...
                                    <p class="card-category">Authority can Update Permission Here...</p>
                                </div>
                                <div class="card-body" >
                                    <form action="{{route('permission.update',$permissions->id)}}" method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <button type="submit" class="btn btn-primary pull-right">Update Permission </button>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <button class="btn btn-primary pull-right" type="reset" ><a href="{{route('permission.index')}}" >Cancel</a></button>
                                                </div>
                                            </div>
                                        </div>
